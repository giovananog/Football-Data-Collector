    ...
    <TableHead>
      <TableRow>
        {headCells.map((headCell) => (
          <TableCell key={headCell.id} align={headCell.align} sx={{ padding: '4px' }}> {/* Ajuste o padding aqui */}
    ...
    <Box>
      <TableContainer>
        <Table>
          ...
          <TableBody>
            {rows.map((row) => (
              <TableRow key={row.position} sx={{ height: '35px' }}> {/* Ajuste a altura aqui */}
                <TableCell align="center" sx={{ padding: '4px' }}>{row.position}</TableCell> {/* Ajuste o padding aqui */}
                ...
                <TableCell align="center" sx={{ padding: '4px' }}>{row.games}</TableCell> {/* Ajuste o padding aqui */}
                <TableCell align="center" sx={{ padding: '4px' }}>{row.wins}</TableCell> {/* Ajuste o padding aqui */}
                <TableCell align="center" sx={{ padding: '4px' }}>{row.draws}</TableCell> {/* Ajuste o padding aqui */}
                <TableCell align="center" sx={{ padding: '4px' }}>{row.losses}</TableCell> {/* Ajuste o padding aqui */}
                <TableCell align="center" sx={{ padding: '4px' }}>{row.goals}</TableCell> {/* Ajuste o padding aqui */}
                <TableCell align="center" sx={{ padding: '4px' }}>{row.goalDifference}</TableCell> {/* Ajuste o padding aqui */}
                <TableCell align="center" sx={{ padding: '4px' }}>{row.points}</TableCell> {/* Ajuste o padding aqui */}
              </TableRow>
            ))}
          </TableBody>
        </Table>
